...
export const categories = [
  {
    ...
    path: "digital",
    icon: BsAndroid2,
    descrition: "디지털 카테고리입니다.",
  },
  {
    label: "생활가전",
    path: "appliances",
    icon: SlScreenDesktop,
    descrition: "생활가전 카테고리입니다.",
  },
  {
    label: "가구/인테리어",
    path: "interior",
    icon: MdOutlineVilla,
    descrition: "가구/인테리어 카테고리입니다.",
  },
  {
    label: "여성의류",
    path: "women-clothiing",
    icon: GiLargeDress,
    descrition: "여성의류 카테고리입니다.",
  },
  {
    label: "남성패션/잡화",
    path: "men-fashion",
    icon: PiTShirtDuotone,
    descrition: "남성패션/잡화 카테고리입니다.",
  },
  {
    label: "뷰티/미용",
    path: "beauty",
    icon: PiFlowerLotus,
    descrition: "뷰티/미용 카테고리입니다.",
  },
  {
    label: "스포츠/레저",
    path: "sports",
    icon: FaSkiing,
    descrition: "스포츠/레저 카테고리입니다.",
  },
  {
    label: "중고차",
    path: "used-car",
    icon: PiCarProfileDuotone,
    descrition: "중고차 카테고리입니다.",
  },
];
